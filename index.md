## Portfolio Projects
---
### Analyzing Canada's Greenhouse Gas Emissions
It is becoming increasing clear that Canada must decrease its greenhouse gas emissions to meet its net zero target and mitigate the impact of climate change on Canadians. In this project, I utilize SQL queries to gain insight into Canada's emissions across time, provinces and sectors. I then visualize the results in an interactive dashboard with tableau.
...
<img src="images/precision-recall threshold plot - PCA.png"/>
...
[View code on Github](https://github.com/grahamgreene88/Antibiotic-Resistance-Prediction/blob/main/Antibiotic%20Resistance%20Prediction%20Notebook-Final-PCA.ipynb)
